...
CTA1.defaultProps = {
  action1: 'Get Started',
  content1:
    'Streamline your cloud operations with our scheduled automation tools to reduce expenses and increase efficiency.',
  heading1: 'Save Costs with Automated Cloud Services',
  action2: 'Learn More',
}
